...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    it "total_revenue does not include the bulk discounts and is specific to one merchant" do
    ...
    it "total_revenue for one merchant including bulk discounts with multiple merchants (but does not calculate the revenues for other items that are not that merchants)" do 
      merchant1 = Merchant.create!(name: 'Hair Care')
    ...
    it "total_revenue of all merchants for one invoice including bulk discounts with multiple merchants" do 
      merchant1 = Merchant.create!(name: 'Hair Care')
      merchant2 = Merchant.create!(name: 'Hady')
